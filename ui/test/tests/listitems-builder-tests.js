...
describe('ListItems Builder', function () {
  it('finds and outputs basic repeating blocks', function () {
    let expectation = '  <span class="test_base ">    Fizzle crazy tortor. Sed rizzle. Pimpin&#39; dolor dapibizzle \
turpis tempizzle fo shizzle my nizzle. Maurizzle pellentesque its fo rizzle izzle turpis. Get down get down we gonna \
chung nizzle. Shizzlin dizzle eleifend rhoncizzle break it down. In yo ghetto platea dictumst. Bling bling dapibizzle. \
Curabitur break yo neck, yall fo, pretizzle eu, go to hizzle dope, own yo&#39; vitae, nunc. Bizzle suscipizzle. Semper \
velit sizzle fo.  </span>  ';
