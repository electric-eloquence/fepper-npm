...
patternlab.patternAssembler.processPattern(listItemPattern, patternlab);
patternlab.patternAssembler.processPattern(listItemsPattern, patternlab);
patternlab.patternAssembler.processPattern(listItemsPatternLocal, patternlab);
patternlab.patternAssembler.processPattern(listItemsPatternMixed, patternlab);
patternlab.patternAssembler.processPattern(listItemsPatternNested, patternlab);

describe('List Item Hunter', function () {
  it('should find and output basic repeating blocks', function () {
    let expectation = '  <span class="test_base ">\n      \n      Fizzle crazy tortor. Sed rizzle. Ass pimpin&#39; ' +
      'dolor dapibizzle turpis tempizzle fo shizzle my nizzle. Maurizzle pellentesque its fo rizzle izzle turpis. ' +
      'Get down get down we gonna chung nizzle. Shizzlin dizzle eleifend rhoncizzle break it down. In yo ghetto ' +
      'platea dictumst. Bling bling dapibizzle. Curabitur break yo neck, yall fo, pretizzle eu, go to hizzle dope, ' +
      'own yo&#39; vitae, nunc. Bizzle suscipizzle. Ass semper velit sizzle fo.\n  </span>\n';
