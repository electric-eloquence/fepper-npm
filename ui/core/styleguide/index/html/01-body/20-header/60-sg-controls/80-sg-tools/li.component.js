...
{{^ ishControlsHide.tools-all }}
  ...
  <ul class="sg-acc-panel sg-right sg-checklist" id="sg-tools">
    {{^ ishControlsHide.tools-docs }}<li><a href="https://fepper.io/docpage" class="sg-tool sg-checklist-icon sg-icon sg-icon-file" target="_blank">${t('Fepper docs')}</a>{{/ ishControlsHide.tools-docs }}
